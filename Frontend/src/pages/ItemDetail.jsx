...
const ItemDetail = () => {
    ...
    if (!item) return <div className="text-center text-text-secondary">Item not found.</div>;
    ...
    return (
        <div>
            ...
            <h1 className="text-4xl font-bold text-glow mb-2">{item.name}</h1>
            <p className="text-text-secondary mb-8 font-mono text-xs">ID: {item._id}</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card>
                    <h2 className="text-xl font-semibold text-text-primary mb-4 border-b border-border pb-2">Item Information</h2>
                 ...
                 <Card>
                    <h2 className="text-xl font-semibold text-text-primary mb-4 border-b border-border pb-2">Artisan & Description</h2>
                     {item.artisanID ? (
                        <div className="divide-y divide-border">
                     ...
                     <div className="mt-4 border-t border-border pt-4">
                        <div className="flex items-center text-sm text-text-secondary mb-1"><AlignLeft className="h-4 w-4 mr-2" />Description</div>
                        <p className="text-md text-text-primary mt-1 pl-6">{item.description || 'No description provided.'}</p>
                     </div>
                 </Card>
            </div>
        </div>
